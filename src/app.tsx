    ...
    <div className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        <Card className="w-full max-w-md mx-auto text-center border-2 border-primary/20 shadow-xl bg-white/80 backdrop-blur-md overflow-hidden relative">
          ...
          <CardHeader className="pt-8 pb-4">
            ...
            <div className="relative w-fit mx-auto">
              <CardTitle className="text-8xl font-light tracking-tight bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 bg-clip-text text-transparent">
                Envoye
              </CardTitle>
              <span className="font-accent absolute -top-7 -right-4 text-8xl text-indigo-600 select-none -rotate-45">
                e
              </span>
            </div>
            <CardDescription className="text-gray-500 font-medium px-4">
              Escanea tu invitación QR, tómate fotos o videos y comparte tus
              felicitaciones en un mural 3D interactivo.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="w-full max-w-md mx-auto text-center border-2 border-accent/30 shadow-xl bg-white/90 backdrop-blur-md p-6">
          <CardHeader className="pb-4">
            ...
            <CardDescription className="text-gray-500 font-medium px-2">
              Tu carta de felicitación y multimedia han sido agregados con éxito
              al mural del evento.
            </CardDescription>
          </CardHeader>
      ...
      {state === "gallery" && (
        <div className="fixed inset-0 z-50">
          <Gallery3D eventId={activeEventId} onBack={() => setState("home")} />
        </div>
      )}
    </div>
  );
