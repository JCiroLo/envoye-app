        ...
        <div className="flex flex-col items-center w-full max-w-sm">
          ...
          <div className="flex gap-4 w-full">
            ...
            {mode === 'video' && (
              <>
                {!recording ? (
                  <Button type="button" variant="default" onClick={startRecording} className="flex-1 h-12 bg-red-500 text-white hover:bg-red-600">
                    Iniciar Grabación
                  </Button>
                ) : (
                  <Button type="button" variant="destructive" onClick={stopRecording} className="flex-1 h-12 flex items-center justify-center gap-2">
      ...
      {capturedUrl && capturedType && (
        <div className="flex flex-col items-center w-full max-w-sm">
          ...
          <div className="flex gap-3 w-full">
            <Button type="button" variant="pastel" onClick={handleConfirm} className="flex-1 h-12 border border-teal-200/50">
